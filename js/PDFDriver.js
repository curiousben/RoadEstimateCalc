                     ...
                     '(This is not intended to be a detailed pay item breakdown. It is intended to be a tool that assists users in preparing early estimates prior to having developed plans. TRNSPRT should be utilites by the PFI stage.)',
                     {
                             table: 
                             {
                                     ...
                                     [
                                             ...
                                             ['Grading Items Contingency',{ colSpan: 3, text:'%5.00'},'','','$'+numberleftblankcomma(GradingItems()[7].toFixed())+''],
                                             ...
                                             ['Drainage Items Contingency',{ colSpan: 3, text:'%5.00'},'','','$'+numberleftblankcomma(DrainageItems()[7].toFixed())+''],
                                             ...
                                             ['Pavement Items Contingency',{ colSpan: 3, text:'%5.00'},'','','$'+numberleftblankcomma(PavementItems()[6].toFixed())+''],
                                             ...
                                             ['Incidental Items Contingency',{ colSpan: 3, text:'%5.00'},'','','$'+numberleftblankcomma(IncidentalItems()[5].toFixed())+''],
                                             ...
                                             ['Protective Items Contingency',{ colSpan: 3, text:'%5.00'},'','','$'+numberleftblankcomma(ProtectiveItems()[4].toFixed())+''],
                                             ...
                                             ['Erosion Items Contingency',{ colSpan: 3, text:'%5.00'},'','','$'+numberleftblankcomma(ErosionItems()[5].toFixed())+''],
                                             ...
                                             ['Utilities Items Contingency',{ colSpan: 3, text:'%5.00'},'','','$'+numberleftblankcomma(UtilItems()[2].toFixed())+''],
                                             ...
                                             ['Traffic and Safety Items Contingency',{ colSpan: 3, text:'%5.00'},'','','$'+numberleftblankcomma(TrafficandSafetyItems()[6].toFixed())+''],
                                             ...
                                             ['Bridge Items Contingenc',{ colSpan: 3, text:'%5.00'},'','','$'+numberleftblankcomma(BridgeItems()[3].toFixed())+''],
