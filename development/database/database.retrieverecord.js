...
var EstimatorListData = [],
	...
	$('#ImportDatarecord').click(function(){
		...
		if (thisEstiObject != 'empty') {
			...
			localStorage.setItem('ImportEstimator',thisEstiObject.Estimator);
			localStorage.setItem('ImportUPC',thisEstiObject.UPC);
			localStorage.setItem('ImportRoadNumber',thisEstiObject.RoadNumber);
		};
	});
});